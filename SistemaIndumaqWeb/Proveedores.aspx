<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="SistemaIndumaqWeb.Proveedores" %>
    ...
    <form id="form1" runat="server">
        <div id="navbar">
            <ul>
                ...
                <li><a class="seleccion" href="Proveedores.aspx">Proveedores</a></li>
        ...
        <div id="agregar" class="contAgregar" runat="server">
            <h1 id="titParrafo" class="tituloParrafo" runat="server">Agregar nuevo proveedor</h1>
